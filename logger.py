#this code is written by Edwin Sutanudjaja. I cloned it from
#https://github.com/edwinkost/PCR-GLOBWB_monthly_GRDC_analysis
#Rolf Hut, 2015-06-10
...
class Logger(object):
    ...
    def __init__(self, log_folder, log_front_filename = None, cleanLogDir = False):
        object.__init__(self)

        # initialize logging and its properties 
        # (log file, debug level, format, etc.)
        self.initialize_logging(log_folder, log_front_filename, cleanLogDir)

    def initialize_logging(self, log_folder, log_front_filename = None, cleanLogDir = False):
        """
